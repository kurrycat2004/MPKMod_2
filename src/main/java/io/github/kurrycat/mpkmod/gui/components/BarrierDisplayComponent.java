...
public class BarrierDisplayComponent extends ResizableComponent {
    ...
    public void render(Vector2D mouse) {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null && !(this.mc.thePlayer.hasReducedDebug() || this.mc.gameSettings.reducedDebugInfo)) {
            ...
            if (String.valueOf(Block.blockRegistry.getNameForObject(iblockstate.getBlock())).equals("minecraft:barrier")) {
